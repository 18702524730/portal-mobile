...
const settingUser = (params)=>postAction("/sys/user/settingUser",params);
...
//用户信息重复校验
const duplicateCheckByUser = (params)=>getAction("/sys/duplicate/checkByUser",params);

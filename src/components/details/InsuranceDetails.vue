      ...
      <div style="height: 100%">
        ...
        <div class="my-main-content">
          <van-row class="content-card">
            <van-row>
              <van-image :src="getImgNewView(item.productImage)" class="my-image"/>
            </van-row>
          ...
          <van-row>
            <van-tabs v-model="active" title-inactive-color="#666666" title-active-color="#2F72D1" background="#ffffff"
              ...
              <van-tab title="产品介绍" name="1">
                <div v-html="item.introduction" style="white-space: pre-wrap;word-break: break-all;overflow-x: auto" class="introduction">
                </div>
              </van-tab>
            </van-tabs>
          </van-row>

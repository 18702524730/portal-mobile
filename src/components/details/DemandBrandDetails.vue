    ...
    <van-popup v-model="detailsShow" position="right" class="my-popup" safe-area-inset-bottom get-container="#app">
      <div style="height: 100%">
        ...
        <div class="my-main-content">
          ...
          <van-row>
            <content-body title="商标需求内容"
                          :contentArr="[
                          {content:item.trademarkRemark,littleTitle:'需求简介',isHtml:true}
                          ]"
                          v-if="item.trademarkRemark"></content-body>
          </van-row>

          <van-row>
            <content-body title="商标需求描述"
                          :contentArr="[
                          {content:item.trademarkDesc,littleTitle:'商标需求描述',isHtml:true},
                          {content:item.applicableField,littleTitle:'适用的领域/范围',isHtml:false}
                          ]"

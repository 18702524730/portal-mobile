    ...
    <div class="patentdetails">
      ...
      <div class="cont clearfix">
        ...
        <div class="allcont" id="contbox">
          <div class="commontitle tables">
            <span :class="{ active: current === 0 }" @click="changelabel(0)">基本信息</span>
            <span :class="{ active: current === 2 }" @click="changelabel(2)">事务公告</span>
            <span :class="{ active: current === 4 }" @click="changelabel(4)">费用信息</span>
            <span :class="{ active: current === 6 }" @click="changelabel(6)">说明书及附图</span>
          </div>
          ...
          <div class="citation" v-if="current === 8 && detailInfo.pledgeTransferPermit">
            ...
            <h3 class="commontitle" v-if="detailInfo.pledgeTransferPermit.patentTransfer">
              中国专利申请权、申请权的转移
            </h3>

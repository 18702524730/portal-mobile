<template>
  <div id="mobileFinancialConsultShow">
    <message-list :data="data" :pagination="ipagination" :have-page="data.length > 0" @func="refresh"
                  :columns="columns" :have-search="true" :key-route="keyRoute" route-name="MobileFinancialConsultArticleMessage"></message-list>
  </div>
</template>
  ...
  export default {
    ...
    data() {
      return {
        ...
        keyRoute: 'MobilePledgeFinancing',
        columns: [
          {
            title: '标题',
            dataIndex: 'title',

<template>
  <div id="mobileSupplyPatentCenter">
    ...
    <van-popup v-model="show" position="right" style="height: 100%;width: 75%" class="my-popup"
      ...
      <van-row class="my-popup-content">
        <supply-patent-form ref="myForm"></supply-patent-form>
      </van-row>
...
<script>
  ...
  export default {
    ...
    components: { SupplyPatentForm, RecommendSupplyCard, RecommendOrganization, OrderButton },
    created() {

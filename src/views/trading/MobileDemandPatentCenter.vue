<template>
  <div id="mobileDemandPatentCenter">
    ...
    <van-popup v-model="show" position="right" style="height: 100%;width: 75%" class="my-popup"
      ...
      <van-row class="my-popup-content">
        <supply-patent-form ref="myForm" demand-or-supply="demand"></supply-patent-form>
      </van-row>
...
<script>
  ...
  import SupplyPatentForm from '../../components/form/SupplyPatentForm'
  ...
  export default {
    ...
    components: { SupplyPatentForm, RecommendDemandCard, RecommendOrganization, OrderButton },
    created() {

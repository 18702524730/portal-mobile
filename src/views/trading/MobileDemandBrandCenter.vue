<template>
  <div id="mobileDemandBrandCenter">
    ...
    <van-popup v-model="show" position="right" style="height: 100%;width: 75%" class="my-popup"
      ...
      <van-row class="my-popup-content">
        <supply-brand-form ref="myForm" demand-or-supply="demand"></supply-brand-form>
      </van-row>
...
<script>
  ...
  export default {
    ...
    components: { SupplyBrandForm, RecommendDemandCard, RecommendOrganization, OrderButton },
    created() {

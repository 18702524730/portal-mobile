  ...
  <div id="mobileSupplyCenter">
    ...
    <van-popup v-model="show" position="right" style="height: 100%;width: 75%" class="my-popup"
      ...
      <van-row class="my-popup-content">
        <supply-project-form ref="myForm"></supply-project-form>
      </van-row>
...
<script>
  ...
  export default {
    ...
    components: { RecommendSupplyCard, RecommendOrganization, SupplyProjectForm, OrderButton },
    created() {
